...
module.exports.run = async (bot, message, args) => {
    ...
    let startMessage = new Discord.RichEmbed()
        .setTitle("NA Fortnite Scrims INFO ")
        .setDescription("Make sure to load your game content to 100% and join the voice channel for the next scrim match countdown. if your Not familiar on how to join? read the getting-started chat for more information")
        .setColor("#8600b3")
        .setFooter("Fortnite Scrims Discord");
    ...
    let timeEmbed = new Discord.RichEmbed()
        .setTitle(" Get Ready, Match is Starting in approximately...")
    ...
    let last3 = new Discord.RichEmbed()
        .setTitle("Last Three # of Game ID")
        .setColor("#8600b3");
    ...
    const collector = snipeChannel.createMessageCollector(filter, {max: 200, maxMatches: 200, time: 0});
